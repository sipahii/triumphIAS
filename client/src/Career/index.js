          ...
          <div className={Styles.courcesPage__rowflex}>
            <div className={Styles.courcesPage__rowflex__couresDetails}>
              <div className={Styles.courcesPage__rowflex__couresDetails__inner}>
                ...
                <p>
                  <strong>At TriumphIAS </strong> we help students realize their potential and achieve their dreams.
                </p>
                ...
                <h4>
                  Drop in your resume @ <span> career@triumphias.com </span> Or contact us @ <b> +91-7840888102</b>
                </h4>
              </div>
            </div>
          </div>
