          ...
          <div className={Styles.courcesPage__rowflex}>
            <div className={Styles.courcesPage__rowflex__couresDetails}>
              <div className={Styles.courcesPage__rowflex__couresDetails__inner}>
                ...
                <CommanHeading heading="2. Education" />
                ...
                <CommanHeading heading="Numbers Of Attempts" />
                ...
                <CommanHeading heading="Vacancies And Selection" />
                ...
                <CommanHeading heading="List Of Services" />
                ...
                <CommanHeading heading="Preliminary Test Stage" />
                <p>
                  ...
                  numeracy, data interpretation, English language comprehension skills and mental ability.
                  <br />
                ...
                <CommanHeading heading="Mains Stage" />
                <p>
                  The Civil Services Mains Examination consists of a written examination and an interview.
                  <br />
                  The written examination consists of nine papers, two qualifying and seven ranking in nature. The range of questions may vary. Candidates who pass qualifying papers are ranked according to marks and a selected number of candidates are called for interview or a personality test at the Commission’s discretion According to the new marks allocations in Civil Service Examination 2013 there are some changes made in the examination according to the suggestion of the Prof. S. Nigavekar
                  Committee. However, after some controversy, the qualifying papers for Indian languages and English were restored to the examination.
                </p>

                <CommanHeading heading="Civil Services New Mains Format" />
                <Item para="Paper" />
                <Item para="Subject" />
                <Item para="Marks" />
                ...
                <CommanHeading heading="Interview" />
                <p>
                  ...
                  critical powers of assimilation, clear and logical exposition, balance of judgement, variety and depth of interest, ability for social cohesion and leadership, and intellectual and moral integrity.
                  <br />
                  The technique of the interview is not that of a strict cross-examination, but of a natural, though directed and purposive conversation that is intended to reveal the mental qualities of the candidate. The interview is not intended to be a test either of the specialised or general knowledge of the candidate, which has been already tested through written papers. Candidates are expected to have taken an intelligent interest not only in their special subjects of academic study, but
                  also in the events which are happening around them both within and outside their own state or country as well as in modern currents of thought and in new discoveries which should rouse the curiosity of all well-educated youth.
                </p>
              </div>
            </div>
          </div>
