...
const GsPracticeSeries = () => {
  const para = (
    <p>
      ...
      <br />
      Chat With Us:<strong> Click Here to Chat</strong>
    </p>
  );
  const para1 = (
    <p>
      General Science.
      <br />
      <strong> UPSC Syllabus for Paper II-</strong> (200 marks) Duraon: Two hours (Not counted for the merit rank in Prelims but a qualifying Paper; just needs 33% marks).
    </p>
  );
  return (
    <>
          ...
          <div className={Styles.courcesPage__rowflex}>
            <div className={Styles.courcesPage__rowflex__couresDetails}>
              <div className={Styles.courcesPage__rowflex__couresDetails__inner}>
                ...
                <CommanHeading heading="Programme Highlights:" />
                ...
                <CommanHeading heading="PRELIMINARY STRATEGY:" />
                ...
                <CommanHeading heading="Importance of a Revision & Practice under Mentorship" />
                ...
                <CommanHeading heading="What is Preliminary stage of Civil Services Examination?" />
                ...
                <CommanHeading heading="What is Syllabus for Preliminary Stage?" />
