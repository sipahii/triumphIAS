...
const SociologyStudyPlusTest = () => {
  ...
  return (
    <>
      {!enroll ? (
        <>
          <CommanBanner section="Sociology Test + Study Material" />
            ...
            <Container>
              ...
              <div className={Styles.courcesPage__rowflex}>
                ...
                <div className={Styles.courcesPage__rowflex__sidebar}>
                  <CourcePrice price={coursePrice} onClick={onRegistrationHandler} courseName="Sociology Test + Study Material" />
                  <PaymentDetails />
                  <AskQuestion />
                  <ApplyNow />
                </div>
...
export default SociologyStudyPlusTest;
