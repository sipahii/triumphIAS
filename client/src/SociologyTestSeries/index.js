...
const SociologyTestSeries = () => {
  const [coursePrice, setCoursePrice] = useState("19,000");
          ...
          <div className={Styles.courcesPage}>
            <Container>
              <div className={Styles.courcesPage__top}>
                <Tab onClick={onCourseHandler} btnName="Online Course Fee" price="19,000" class={coursePrice === "19,000" ? Styles.active : ""} />
                <Tab onClick={onCourseHandler} btnName="Offline Course Fee" price="20,000" class={coursePrice === "20,000" ? Styles.active : ""} />
              </div>
