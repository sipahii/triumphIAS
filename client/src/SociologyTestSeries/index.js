...
const SociologyTestSeries = () => {
  const { onRegistrationHandler, onCourseHandler, courseName, coursePrice, enroll, courseType } = useCourse("19,000", "Online");
  return (
    <>
      {!enroll ? (
        <>
          <CommanBanner section="sociology test series" />
          <div className={Styles.courcesPage}>
            <Container>
              <div className={Styles.courcesPage__top}>
                <Tab onClick={onCourseHandler} onlineOffline="Online" btnName="Online Course Fee" price="19,000" class={coursePrice === "19,000" ? Styles.active : ""} />
                <Tab onClick={onCourseHandler} onlineOffline="Offline" btnName="Offline Course Fee" price="20,000" class={coursePrice === "20,000" ? Styles.active : ""} />
              </div>
              <div className={Styles.courcesPage__rowflex}>
                ...
                <div className={Styles.courcesPage__rowflex__sidebar}>
                  <CourcePrice price={coursePrice} onClick={onRegistrationHandler} courseName="Sociology Test Series" />
                  <PaymentDetails />
                  <AskQuestion />
                  <ApplyNow />
                </div>
