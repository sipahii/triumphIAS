...
const SociologyOffline = () => {
  ...
  return (
    <>
      {!enroll ? (
        <>
          <CommanBanner section="Sociology Offline" />
            ...
            <Container>
              <div className={Styles.courcesPage__rowflex}>
                ...
                <div className={Styles.courcesPage__rowflex__sidebar}>
                  <CourcePrice price="51,500" onClick={onRegistrationHandler} courseName="Sociology Foundation With Daily Answer Writing " />
                  <PaymentDetails />
                  <AskQuestion />
                  <ApplyNow />
                </div>
