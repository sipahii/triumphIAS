        ...
        <div className={Styles.courcesPage__tabArea}>
          <div className={Styles.courcesPage__tabArea__wrap}>
            <ul className={Styles.courcesPage__tabArea__wrap__tabNav}>
              <li className={`${Styles.list} ${active === "Features" ? Styles.active : ""}`} onClick={() => menuChangeHandler("Features")}>
                Features{" "}
              </li>
              <li className={`${Styles.list} ${active === "Lecturers" ? Styles.active : ""}`} onClick={() => menuChangeHandler("Lecturers")}>
                Lecturers
              </li>
              <li className={`${Styles.list} ${active === "Reviews" ? Styles.active : ""}`} onClick={() => menuChangeHandler("Reviews")}>
                Reviews
              </li>
            </ul>
          </div>
        ...
        <div className={Styles.courcesPage__tabContant}>
          ...
          {show === "Lecturers" && (
            <div className={Styles.courcesPage__tabContant__item2}>
              <CommonLactures image={Image1} name=" Kazi Fahim" profession="Senior UI Designer" day="Wed Day" time="9 am - 11 am" />
              <CommonLactures image={Image2} name=" Kazi Fahim" profession="Senior UI Designer" day="Sun Day" time="08 pm-10 pm" />
              <CommonLactures image={Image1} name=" Kazi Fahim" profession="Senior UI Designer" day="Mon Day" time="04 pm-11 pm" />
            </div>
          )}
          {show === "Reviews" && (
