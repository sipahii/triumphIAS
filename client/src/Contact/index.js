            ...
            <div className={Styles.contact__page__wrap}>
              <div className={Styles.contact__page__wrap__info1}>
                <ul className={Styles.contact__page__wrap__info1__ul}>
                  <CommonInfoLi icon="fa-solid fa-phone" name="Phone" para="+61 3 8376 6284" />
                  <CommonInfoLi icon="fa-solid fa-location-dot" name="Address" para="PO Box 1212, California, US." />
                  <CommonInfoLi icon="fa fa-envelope-o" name="E-Mail" para="academics@gmail.com" />
